...
METRICS: dict[str, MetricDef] = {
    ...
    "battery_temperature": MetricDef(
        key="battery_temperature", display_name="Battery Temperature", unit="C",
        value_type="gauge", aggregation="max",
        min_valid=-20, max_valid=90,
        stale_after_s=900, hot=True,
        group="power", rate_of=None, rate_scale=1.0,
        device_types=("ups",),
        alarm_scope="instance",
    ),
    "coolant_temperature": MetricDef(
        key="coolant_temperature", display_name="Coolant Temperature", unit="C",
        value_type="gauge", aggregation="max",
        min_valid=-20, max_valid=130,
        stale_after_s=900, hot=True,
        group="power", rate_of=None, rate_scale=1.0,
