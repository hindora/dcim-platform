"""Re-sync the metric table after the cooling and power groups were added.

Revision ID: 0007
Revises: 0006

Phase 3.3 added 33 cooling and power metrics to the registry for the BACnet
adapter. The mechanism is 0004 verbatim, with a new revision id - see that
file for why a sync deprecates rather than deletes.
