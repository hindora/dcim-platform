...
Runs synchronously against psycopg-style URLs; the application URL is
asyncpg, so the driver is stripped by ``Settings.sync_database_url``.
"""
...
def include_object(obj, name, type_, reflected, compare_to):
    ...
    if type_ == "table" and name.startswith(("_hyper_", "_compressed_", "_timescaledb")):
        return False
